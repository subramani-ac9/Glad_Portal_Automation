export const EncMediaLocators = {
  ...
  //search and no data locators
   searchInputEncMedia:'div:has(input[placeholder="Search by products"])',
  noResourcesEncMedia:"No resources available",  
  // View Media Modal Locators
  viewMediaProducts: "[role='dialog'] .mantine-Badge-root",
  viewMediaCancelBtn:"xpath=/html/body/div[20]/div/div/div/div[2]/section/div[1]/button",
};
